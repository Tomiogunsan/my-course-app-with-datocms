...
export default function LearnSectionRecord({details}) {
  return (
    <div className='max-w-8xl mx-auto py-20 px-8'>
        ...
        <div className='mx-auto px-8 xl:px-0 py-24 text-8xl text-gray-500 md:flex 
        md:justify-center md:space-x-20 space-y-10 md:space-y-0 max-w-7xl'>
            <div>
              <span className='font-extrabold text-black flex items-cente '>
                <span>{details.}</span>
                <span className='text-purple-500 text-2xl'>+</span>
                <span className='block mt-2 text'>lessons</span>
                </span>
            </div>
        </div>
    </div>
